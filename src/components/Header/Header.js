          ...
          <div className="relative z-10 bg-white pb-8 sm:pb-16 md:pb-20 lg:w-full lg:max-w-2xl lg:pb-28 xl:pb-32">
                  ...
                  <div className="flex flex-shrink-0 flex-grow items-center lg:flex-grow-0">
                    <div className="flex w-full items-center justify-between md:w-auto">
                      <NavLink to="/">
                        ...
                        <h1 className="text-2xl font-semibold text-orange-600 uppercase">
                          MIDAS HR
                        </h1>
                      </NavLink>
            ...
            <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                ...
                <img
                  className="mt-5 h-50"
                  src="https://wpblog.zyro.com/cdn-cgi/image/w=700,q=85/wp-content/uploads/2021/06/dhirubhai-ambani-quote-1536x864.jpg"
                  alt="build yours"
                />
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  ...
                  <div className="mt-3 sm:mt-0 sm:ml-3">
                    <NavLink
                      to="/"
                      onClick={() => setOpen(true)}
                      className="flex w-full items-center justify-center rounded-md border border-transparent bg-orange-100 px-8 py-3 text-base font-medium text-orange-700 hover:bg-orange-200 md:py-4 md:px-10 md:text-lg"
                    >
                      Live demo
                    </NavLink>
                  </div>
